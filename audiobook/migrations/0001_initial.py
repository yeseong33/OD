    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temp_voice_image_path', models.ImageField(null=True, upload_to='voice_images/')),
                ('temp_voice_sample_path', models.FileField(null=True, upload_to='voice_sample/')),
                ('temp_voice_rvc_path', models.FileField(null=True, upload_to='voice_rvc/')),
            ],
        ),
        migrations.CreateModel(
            name='Voice',
