    ...
    def post(self, request, book_id):
        ...
        if action == 'play':
            ...
            if voice_creation_data:
                ...
                redirect_url = reverse('audiobook:voice_custom', kwargs={'book_id': book_id})
                return JsonResponse({'redirect_url': redirect_url})
            ...
            if voice_creation_data:
                ...
                client.close()
                redirect_url = reverse('audiobook:voice_custom_upload', kwargs={'book_id': book_id})
                return JsonResponse({'redirect_url': redirect_url})
